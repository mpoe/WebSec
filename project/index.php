    ...
    <body>
        ...
        <div class="TopBar">
            ...
            <form action="api/login.php" method="post" class="TopBar_Form"> <!-- Needs form information -->
                ...
                <input class="TopBar_Password" name="login-password" placeholder="Password" type="password" tabindex="2" autocomplete="off">
                <input class="TopBar_Username" name="login-email" placeholder="E-mail"  tabindex="1" autocomplete="off">
            </form>
        </div>
